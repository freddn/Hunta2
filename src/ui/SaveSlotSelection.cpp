...
void SaveSlotSelection::init() {
    ...
    slot1.getButtonTextField()->setText("No saved game", game::getTextColor(), game::getFont());
    slot1.onClick([](/* TODO goto Settings */) { });

    slot2.setImg("data/button.png", true, 256, 64);
    slot2.setRect(32*1, 120, 256, 64);
    slot2.getButtonTextField()->setText("No saved game", game::getTextColor(), game::getFont());
    slot2.onClick([](/* TODO goto Settings */) { });

    slot3.setImg("data/button.png", true, 256, 64);
    slot3.setRect(32*1, 200, 256, 64);
    slot3.getButtonTextField()->setText("No saved game", game::getTextColor(), game::getFont());
...
void SaveSlotSelection::setSlot(int slot, std::string name, int level) {
    ...
    case 1:
        ...
        slot1.getButtonTextField()->setText(name+" LV"+std::to_string(level), game::getTextColor(), game::getFont());
        break;
    case 2:
        HelperFunctions::log(name + " LV " + std::to_string(level));
        slot2.getButtonTextField()->setText(name+" LV"+std::to_string(level), game::getTextColor(), game::getFont());
        break;
    case 3:
        HelperFunctions::log(name + " LV " + std::to_string(level));
        slot3.getButtonTextField()->setText(name+" LV"+std::to_string(level), game::getTextColor(), game::getFont());
        break;
    default:
        break;
    }
